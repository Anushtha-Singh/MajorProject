...
export const sampleSchemes = [
  ...
  },
  {
    ...
    eligibilityHindi: "एसईसीसी डेटाबेस के अनुसार पहचाने गए परिवार (सामाजिक-आर्थिक जाति जनगणना)",
    applicationProcess: [
      "Check eligibility on official website",
      "Visit empaneled hospital",
      "Show Aadhaar card for verification",
      "Get treatment without paying upfront"
    ],
    applicationProcessHindi: [
      "आधिकारिक वेबसाइट पर पात्रता जांचें",
      "पैनल अस्पताल पर जाएं",
      "सत्यापन के लिए आधार कार्ड दिखाएं",
      "अग्रिम भुगतान किए बिना उपचार प्राप्त करें"
    ],
    documentsRequired: [
      "Aadhaar Card",
  ...
  },
  {
    ...
    applicationProcessHindi: [
      ...
      "संबंधित प्राधिकरण द्वारा सत्यापन",
      "अनुमोदन और धन वितरण"
    ],
    documentsRequired: [
      "Aadhaar Card",
  ...
  },
  {
    ...
    applicationProcessHindi: [
      "किसी भी बैंक, एनबीएफसी या एमएफआई पर जाएं",
      "आवेदन पत्र भरें",
      "आवश्यक दस्तावेज जमा करें",
  ...
  },
  {
    ...
    applicationProcess: [
      ...
      "Fill application form with Aadhaar details",
      "Submit required documents",
      "Get LPG connection and cylinder"
    ],
    applicationProcessHindi: [
      "निकटतम एलपीजी डिस्ट्रीब्यूटर पर जाएं",
      "आधार विवरण के साथ आवेदन पत्र भरें",
      "आवश्यक दस्तावेज जमा करें",
      "एलपीजी कनेक्शन और सिलेंडर प्राप्त करें"
    ],
    documentsRequired: [
      "Aadhaar Card",
      "BPL Ration Card",
...
export const languagePatterns = {
  ...
  ml: /[\u0D00-\u0D7F]/g, // Malayalam
  or: /[\u0B00-\u0B7F]/g, // Odia
  mr: /[\u0900-\u097F]/g, // Marathi (uses Devanagari)
};
